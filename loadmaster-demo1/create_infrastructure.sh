...
# Create NSG
az deployment group create --resource-group DemoResourceGroup --template-file ./templates/az/nsg.json --parameters "{\"networkSecurityGroupName\": {\"value\": \"${RESOURCE_GROUP}-nsg\"}}"
